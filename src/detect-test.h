...
#ifndef __DETECT_TEST_H__
#define __DETECT_TEST_H__

/** Per keyword data. This is set up by the DetectTestSetup() function.
 *  Each signature will have an instance of DetectTestData per occurence
 *  of the keyword.
