...
#ifndef __DETECT_TESTT_H__
#define __DETECT_TESTT_H__

/** Per keyword data. This is set up by the DetectTesttSetup() function.
 *  Each signature will have an instance of DetectTesttData per occurence
 *  of the keyword.
 *  The structure should be considered static/readonly after initialization.
 */
typedef struct DetectTesttData_ {
    uint8_t arg1;
    uint8_t arg2;
} DetectTesttData;
