...
#ifndef __DETECT_ARP_H__
#define __DETECT_ARP_H__

/** Per keyword data. This is set up by the DetectArpSetup() function.
 *  Each signature will have an instance of DetectArpData per occurence
 *  of the keyword.
 *  The structure should be considered static/readonly after initialization.
 */
typedef struct DetectArpData_ {
